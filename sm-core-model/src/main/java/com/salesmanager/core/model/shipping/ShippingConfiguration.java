...
import static com.salesmanager.core.model.shipping.ShippingBasisType.BILLING;
import static com.salesmanager.core.model.shipping.ShippingBasisType.SHIPPING;
import static com.salesmanager.core.model.shipping.ShippingDescription.LONG_DESCRIPTION;
import static com.salesmanager.core.model.shipping.ShippingDescription.SHORT_DESCRIPTION;
...
public class ShippingConfiguration implements JSONAware {
    ...
    //enums
    private ShippingType shippingType = NATIONAL;
    private ShippingBasisType shippingBasisType = SHIPPING;
    private ShippingOptionPriceType shippingOptionPriceType = ALL;
    private ShippingPackageType shippingPackageType = ITEM;
    private ShippingDescription shippingDescription = SHORT_DESCRIPTION;
    ...
    private String shipOptionPriceType = ALL.name();
    ...
    public void setShipType(String shipType) {
        ...
        ShippingType sType = NATIONAL;
        if (shipType.equals(INTERNATIONAL.name())) {
            sType = INTERNATIONAL;
        }
    ...
    public void setShipOptionPriceType(String shipOptionPriceType) {
        ...
        ShippingOptionPriceType sType = ALL;
        if (shipOptionPriceType.equals(HIGHEST.name())) {
            sType = HIGHEST;
        }
        if (shipOptionPriceType.equals(LEAST.name())) {
            sType = LEAST;
        }
    ...
    public void setShipBaseType(String shipBaseType) {
        ...
        ShippingBasisType sType = SHIPPING;
        if (shipBaseType.equals(BILLING.name())) {
            sType = BILLING;
        }
    ...
    public void setShipPackageType(String shipPackageType) {
        ...
        ShippingPackageType sType = ITEM;
        if (shipPackageType.equals(BOX.name())) {
            sType = BOX;
        }
    ...
    public void setShipDescription(String shipDescription) {
        ...
        ShippingDescription sType = SHORT_DESCRIPTION;
        if (shipDescription.equals(LONG_DESCRIPTION.name())) {
            sType = LONG_DESCRIPTION;
        }
    ...
    public void setShipFreeType(String shipFreeType) {
        ...
        ShippingType sType = NATIONAL;
        if (shipFreeType.equals(INTERNATIONAL.name())) {
            sType = INTERNATIONAL;
        }
