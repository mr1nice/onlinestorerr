...
public class CategoryManagementAPITest {
    ...
    public void getCategory() throws Exception {
        ...
        ResponseEntity<ReadableCategory> response = restTemplate.exchange("http://localhost:8080/sm-shop/services/public/DEFAULT/category/100?lang=en", GET, httpEntity, ReadableCategory.class);

        if (response.getStatusCode() != OK) {
            throw new Exception();
        } else {
            out.println(response.getBody() + " Category record found.");
        }
    }
    ...
    public void postCategory() throws Exception {
        ...
        out.println("New Category ID : " + cat.getId());
    }
