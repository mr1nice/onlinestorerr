...
public class CustomerRESTControllerTest {
	...
	public void getCustomers() throws Exception {
        ...
        ResponseEntity<ReadableCustomer[]> response = restTemplate.exchange("http://localhost:8080/sm-shop/services/private/DEFAULT/customer", GET, httpEntity, ReadableCustomer[].class);

        if (response.getStatusCode() != OK) {
            throw new Exception();
        } else {
            out.println(response.getBody().length + " Customer records found.");
        }
    }
