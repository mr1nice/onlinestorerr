...
public class PersistableOrderProductPopulator extends
    ...
    public OrderProduct populate(PersistableOrderProduct source, OrderProduct target,
        ...
        notNull(productService, "productService must be set");
        notNull(digitalProductService, "digitalProductService must be set");
        notNull(productAttributeService, "productAttributeService must be set");
