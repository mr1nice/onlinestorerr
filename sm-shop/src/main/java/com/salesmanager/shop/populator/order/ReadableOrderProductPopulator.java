...
public class ReadableOrderProductPopulator extends
	...
	public ReadableOrderProduct populate(OrderProduct source,
        ...
        notNull(productService, "Requires ProductService");
        notNull(pricingService, "Requires PricingService");
        notNull(imageUtils, "Requires imageUtils");
