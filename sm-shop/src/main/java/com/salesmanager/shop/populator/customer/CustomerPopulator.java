...
import static com.salesmanager.core.model.customer.CustomerGender.valueOf;
...
public class CustomerPopulator extends
    ...
    public Customer populate(PersistableCustomer source, Customer target,
        ...
        notNull(customerOptionService, "Requires to set CustomerOptionService");
        notNull(customerOptionValueService, "Requires to set CustomerOptionValueService");
        notNull(zoneService, "Requires to set ZoneService");
        notNull(countryService, "Requires to set CountryService");
        notNull(languageService, "Requires to set LanguageService");
        notNull(groupService, "Requires to set GroupService");
        ...
        try {
            ...
            if (!isBlank(source.getEncodedPassword())) {
            ...
            if (source.getGender() != null && target.getGender() == null) {
                target.setGender(valueOf(source.getGender()));
            }
            ...
            if (sourceBilling != null) {
                ...
                if (!isBlank(sourceBilling.getCountry())) {
                ...
                if (billingCountry != null && !isBlank(sourceBilling.getZone())) {
            ...
            if (target.getBilling() == null && source.getBilling() != null) {
                ...
                Billing billing = new Billing();
                Country billingCountry = null;
                if (isNotBlank(source.getBilling().getCountry())) {
            ...
            if (sourceShipping != null) {
                ...
                if (!isBlank(sourceShipping.getCountry())) {
                ...
                if (deliveryCountry != null && !isBlank(sourceShipping.getZone())) {
            ...
            if (target.getDelivery() == null && source.getDelivery() != null) {
                ...
                Delivery delivery = new Delivery();
                Country deliveryCountry = null;
                if (isNotBlank(source.getDelivery().getCountry())) {
