...
public class ProductAttributeController {
	...
	private String displayAttribute(Long productId, Long id, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (id != null && id.intValue() != 0) {
            ...
            attribute.setAttributeAdditionalWeight(valueOf(attribute.getProductAttributeWeight().intValue()));
            attribute.setAttributeSortOrder(valueOf(attribute.getProductOptionSortOrder()));
	...
	public String saveAttribute(@Valid @ModelAttribute("attribute") ProductAttribute attribute, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
        ...
        try {
            Integer sortOrder = parseInt(attribute.getAttributeSortOrder());
        ...
        try {
            Integer weight = parseInt(attribute.getAttributeAdditionalWeight());
        ...
        if (option.getProductOptionType().equals(TEXT_OPTION)) {
            ...
            if (dbEntity != null && dbEntity.getProductOption().getProductOptionType().equals(TEXT_OPTION)) {
                ...
                String code = randomAlphanumeric(10).toUpperCase();
