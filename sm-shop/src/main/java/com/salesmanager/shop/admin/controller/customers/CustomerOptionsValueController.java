...
import static com.salesmanager.shop.admin.controller.ControllerConstants.Tiles.Customer;
import static com.salesmanager.shop.admin.controller.ControllerConstants.Tiles.Customer.optionsValueDetails;
import static com.salesmanager.shop.admin.controller.ControllerConstants.Tiles.Customer.optionsValuesList;
	...
	public String saveOption(@Valid @ModelAttribute("optionValue") CustomerOptionValue optionValue, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
        ...
        if (descriptions != null && descriptions.size() > 0) {
            ...
            for (CustomerOptionValueDescription description : descriptions) {
                ...
                if (isBlank(description.getName())) {
