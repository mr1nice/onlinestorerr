...
import static com.salesmanager.core.business.constants.Constants.TEST_ENVIRONMENT;
...
import static com.salesmanager.shop.admin.controller.ControllerConstants.Tiles.Payment;
import static com.salesmanager.shop.admin.controller.ControllerConstants.Tiles.Payment.paymentMethod;
import static com.salesmanager.shop.admin.controller.ControllerConstants.Tiles.Payment.paymentMethods;
...
public class PaymentsController {
	...
	public String displayPaymentMethod(@RequestParam("code") String code, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (configuration == null) {
			...
			keys.put("transaction", AUTHORIZECAPTURE.name());
		...
		environments.add(TEST_ENVIRONMENT);
