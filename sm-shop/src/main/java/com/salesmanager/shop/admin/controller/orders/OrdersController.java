...
import static com.salesmanager.core.model.common.CriteriaOrderBy.DESC;
import static com.salesmanager.shop.admin.controller.ControllerConstants.Tiles;
import static com.salesmanager.shop.admin.controller.ControllerConstants.Tiles.Order.orders;
...
public class OrdersController {
	...
	@RequestMapping(value = "/admin/orders/list.html", method = GET)
	...
	@RequestMapping(value = "/admin/orders/paging.html", method = POST)
	public @ResponseBody
		...
		try {
			...
			if (orderList.getOrders() != null) {
				...
				for (Order order : orderList.getOrders()) {
					...
					entry.put("date", formatDate(order.getDatePurchased()));
