...
public class LocalImageFilePathUtils extends AbstractimageFilePath {
    ...
    public String buildStaticimageUtils(MerchantStore store, String imageName) {
        StringBuilder imgName = new StringBuilder().append(getBasePath()).append(FILES_URI).append(SLASH).append(store.getCode()).append("/").append(IMAGE.name()).append("/");
    ...
    public String buildStaticimageUtils(MerchantStore store, String type, String imageName) {
        StringBuilder imgName = new StringBuilder().append(getBasePath()).append(FILES_URI).append(SLASH).append(store.getCode()).append("/").append(type).append("/");
        if (!isBlank(imageName)) {
            imgName.append(imageName);
        }
        return imgName.toString();
    ...
    public String buildManufacturerimageUtils(MerchantStore store, Manufacturer manufacturer, String imageName) {
        return new StringBuilder().append(getBasePath()).append("/").append(store.getCode()).append("/").
                append(MANUFACTURER.name()).append("/")
    ...
    public String buildStoreLogoFilePath(MerchantStore store) {
        return new StringBuilder().append(getBasePath()).append(FILES_URI).append(SLASH).append(store.getCode()).append("/").append(LOGO).append("/")
    ...
    public String buildProductPropertyimageUtils(MerchantStore store, String imageName) {
        return new StringBuilder().append(getBasePath()).append(FILES_URI).append(SLASH).append(store.getCode()).append("/").append(PROPERTY).append("/")
                .append(imageName).toString();
    }
