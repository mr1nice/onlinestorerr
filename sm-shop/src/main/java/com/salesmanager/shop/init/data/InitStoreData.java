...
import static com.salesmanager.core.model.catalog.product.relationship.ProductRelationshipType.FEATURED_ITEM;
...
public class InitStoreData implements InitData {
	...
	public void initInitialData() throws ServiceException {
        ...
        MerchantStore store = merchantService.getMerchantStore(DEFAULT_STORE);
        ...
        availability3.setProduct(product3);
        ...
        availability4.setProduct(product4);
        ...
        availability5.setProduct(product5);
        ...
        availability6.setProduct(product6);
        ...
        relationship.setCode(FEATURED_ITEM.name());
        ...
        order.setLocale(getLocale(store));

        order.setCurrencyValue(new BigDecimal(0.98));
