...
public class ShoppingCategoryRESTController {
    ...
    private static final Logger LOGGER = getLogger(ShoppingCategoryRESTController.class);


    @RequestMapping(value = "/public/{store}/category/{id}", method = GET)
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/private/{store}/category", method = POST)
     ...
     */
    @RequestMapping(value = "/private/{store}/category/{id}", method = DELETE)
