...
public class ProductGroupApi {
    ...
    private static final Logger LOGGER = getLogger(ProductGroupApi.class);
    ...
    @RequestMapping(value = "/private/products/{productId}/group/{code}", method = POST)
    public @ResponseBody
    ReadableProductList addProductToGroup(@PathVariable Long productId, @PathVariable String code, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    @ResponseStatus(OK)
    @RequestMapping(value = "/private/products/{productId}/group/{code}", method = DELETE)
    public @ResponseBody
    ReadableProductList removeProductFromCategory(@PathVariable Long productId, @PathVariable String code, HttpServletRequest request, HttpServletResponse response) throws Exception {
