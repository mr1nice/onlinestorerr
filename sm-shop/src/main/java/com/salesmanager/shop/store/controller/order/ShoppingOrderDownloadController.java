...
import static com.salesmanager.core.model.content.FileContentType.PRODUCT_DIGITAL;
import static com.salesmanager.shop.constants.Constants.CUSTOMER;
...
public class ShoppingOrderDownloadController extends AbstractController {
    ...
    byte[] downloadFile(@PathVariable Long orderId, @PathVariable Long id, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        FileContentType fileType = PRODUCT_DIGITAL;
        ...
        Customer customer = (Customer) super.getSessionAttribute(CUSTOMER, request);
        if (customer == null) {
            response.sendError(404, "Image not found");
            return null;
        }
