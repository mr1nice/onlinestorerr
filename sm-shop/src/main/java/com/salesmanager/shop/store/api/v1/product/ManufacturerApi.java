...
public class ManufacturerApi {
    ...
    private static final Logger LOGGER = getLogger(ManufacturerApi.class);
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/private/manufacturers", method = POST)
    ...
    @RequestMapping(value = "/manufacturers/{id}", method = GET)
    @ResponseStatus(OK)
    @ResponseBody
    ...
    @RequestMapping(value = "/manufacturers/", method = GET)
    @ResponseStatus(OK)
    @ResponseBody
    ...
    @RequestMapping(value = "/private/manufacturers/{id}", method = POST)
    @ResponseStatus(OK)
    @ResponseBody
    ...
    @RequestMapping(value = "/manufacturers/{id}", method = DELETE)
    @ResponseStatus(OK)
    @ResponseBody
