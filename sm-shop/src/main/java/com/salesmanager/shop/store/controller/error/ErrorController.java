...
import static org.jopendocument.util.ExceptionUtils.getStackTrace;
...
public class ErrorController {
    ...
    private static final Logger LOGGER = getLogger(ErrorController.class);
    ...
    public ModelAndView handleException(Exception ex) {
        ...
        if (ex instanceof AccessDeniedException) {
            ...
            model.addObject("stackError", getStackTrace(ex));
