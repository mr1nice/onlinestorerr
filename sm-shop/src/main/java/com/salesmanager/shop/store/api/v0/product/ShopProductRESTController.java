...
public class ShopProductRESTController {
    ...
    private static final Logger LOGGER = getLogger(ShopProductRESTController.class);


    /**
     * Create new product for a given MerchantStore
     */
    @RequestMapping(value = "/private/{store}/product", method = POST)
    ...
    @RequestMapping(value = "/private/{store}/product/{id}", method = DELETE)
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/private/{store}/manufacturer", method = POST)
    @ResponseStatus(CREATED)
    @ResponseBody
    ...
    @RequestMapping(value = "/private/{store}/product/optionValue", method = POST)
    @ResponseStatus(CREATED)
    @ResponseBody
    ...
    @RequestMapping(value = "/private/{store}/product/option", method = POST)
    @ResponseStatus(CREATED)
    @ResponseBody
    ...
    @RequestMapping(value = "/private/{store}/product/review", method = POST)
    @ResponseStatus(CREATED)
    @ResponseBody
    public PersistableProductReview createProductReview(@PathVariable final String store, @Valid @RequestBody PersistableProductReview review, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            //rating maximum 5
            if (review.getRating() > MAX_REVIEW_RATING_SCORE) {
                response.sendError(503, "Maximum rating score is " + MAX_REVIEW_RATING_SCORE);
                return null;
            }
...
/*	*//**
    ...
    @RequestMapping(value = "/public/{store}/product/{id}", method = GET)
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/private/{store}/product/price/{sku}", method = POST)
    @ResponseStatus(CREATED)
    @ResponseBody
     ...
     * ?lang=en|fr otherwise default store language
     */
    @RequestMapping(value = "/private/{store}/product/quantity/{sku}/{qty}", method = POST)
    @ResponseStatus(CREATED)
    @ResponseBody
