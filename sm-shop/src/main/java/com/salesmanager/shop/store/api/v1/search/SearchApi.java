...
public class SearchApi {
    ...
    private static final Logger LOGGER = getLogger(SearchApi.class);
    ...
    public @ResponseBody
    SearchProductList search(@RequestBody SearchProductRequest searchRequest, @RequestParam(value = "lang", required = false) String lang, HttpServletRequest request, HttpServletResponse response) throws Exception {
