...
import static com.salesmanager.shop.store.controller.ControllerConstants.Tiles.Items;
import static com.salesmanager.shop.store.controller.ControllerConstants.Tiles.Items.items_manufacturer;
...
public class ListItemsController {
    ...
    private static final Logger LOGGER = getLogger(ListItemsController.class);
    ...
    public String displayListingPage(@PathVariable String url, Model model, HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
        ...
        /** template **/
        StringBuilder template = new StringBuilder().append(items_manufacturer).append(".").append(store.getStoreTemplate());
