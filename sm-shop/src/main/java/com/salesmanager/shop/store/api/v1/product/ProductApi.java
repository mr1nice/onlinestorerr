...
public class ProductApi {
    ...
    private static final Logger LOGGER = getLogger(ProductApi.class);


    @ResponseStatus(CREATED)
    @RequestMapping(value = {"/private/products", "/auth/products"}, method = POST)
    public @ResponseBody
    PersistableProduct create(@Valid @RequestBody PersistableProduct product, HttpServletRequest request, HttpServletResponse response) throws Exception {

        try {

            MerchantStore merchantStore = storeFacade.getByCode(DEFAULT_STORE);
    ...
    @ResponseStatus(OK)
    @RequestMapping(value = {"/private/products/{id}", "/auth/products/{id}"}, method = PUT)
    public @ResponseBody
    PersistableProduct update(@PathVariable Long id, @Valid @RequestBody PersistableProduct product, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    @ResponseStatus(OK)
    @RequestMapping(value = {"/private/products/{id}", "/auth/products/{id}"}, method = DELETE)
 ...
 *//** default routine **//*
    ...
    @ResponseStatus(CREATED)
    @RequestMapping(value = {"/private/products/{productId}/category/{categoryId}", "/auth/products/{productId}/category/{categoryId}"}, method = POST)
    public @ResponseBody
    ReadableProduct addProductToCategory(@PathVariable Long productId, @PathVariable Long categoryId, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    @ResponseStatus(OK)
    @RequestMapping(value = {"/private/products/{productId}/category/{categoryId}", "/auth/products/{productId}/category/{categoryId}"}, method = DELETE)
    public @ResponseBody
    ReadableProduct removeProductFromCategory(@PathVariable Long productId, @PathVariable Long categoryId, HttpServletRequest request, HttpServletResponse response) throws Exception {
