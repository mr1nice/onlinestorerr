...
import static com.salesmanager.core.model.customer.attribute.CustomerOptionType.Text;
...
import static com.salesmanager.shop.store.controller.ControllerConstants.Tiles.Customer.*;
...
public class CustomerAccountController extends AbstractController {
    ...
    private static final Logger LOGGER = getLogger(CustomerAccountController.class);
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/customLogon.html", method = GET)
    public String displayLogon(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        /** template **/
        StringBuilder template = new StringBuilder().append(customerLogon).append(".").append(store.getStoreTemplate());
    ...
    @RequestMapping(value = "/accountSummary.json", method = GET)
    public @ResponseBody
    ...
    @RequestMapping(value = "/account.html", method = GET)
    public String displayCustomerAccount(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        /** template **/
        StringBuilder template = new StringBuilder().append(customer).append(".").append(store.getStoreTemplate());
    ...
    @PreAuthorize("hasRole('AUTH_CUSTOMER')")
    @RequestMapping(value = "/password.html", method = GET)
    public String displayCustomerChangePassword(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        /** template **/
        StringBuilder template = new StringBuilder().append(Tiles.Customer.changePassword).append(".").append(store.getStoreTemplate());
    ...
    @PreAuthorize("hasRole('AUTH_CUSTOMER')")
    @RequestMapping(value = "/changePassword.html", method = POST)
    public String changePassword(@Valid @ModelAttribute(value = "password") CustomerPassword password, BindingResult bindingResult, Model model, HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
        ...
        emailTemplatesUtils.changePasswordNotificationEmail(customer, store, getLocale(customer.getDefaultLanguage()), request.getContextPath());
     ...
     */
    @PreAuthorize("hasRole('AUTH_CUSTOMER')")
    @RequestMapping(value = {"/attributes/save.html"}, method = POST)
    public @ResponseBody
    ResponseEntity<String> saveCustomerAttributes(HttpServletRequest request, Locale locale) throws Exception {
        ...
        while (parameterNames.hasMoreElements()) {
            ...
            try {
                ...
                if (customerOption.getCustomerOptionType().equals(Text.name())) {
        ...
        super.setSessionAttribute(CUSTOMER, c, request);
    ...
    @PreAuthorize("hasRole('AUTH_CUSTOMER')")
    @RequestMapping(value = "/billing.html", method = GET)
    public String displayCustomerBillingAddress(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        MerchantStore store = getSessionAttribute(MERCHANT_STORE, request);
        Language language = getSessionAttribute(LANGUAGE, request);
        ...
        /** template **/
        StringBuilder template = new StringBuilder().append(Billing).append(".").append(store.getStoreTemplate());
    ...
    @PreAuthorize("hasRole('AUTH_CUSTOMER')")
    @RequestMapping(value = "/editAddress.html", method = {GET, POST})
    public String editAddress(final Model model, final HttpServletRequest request,
        ...
        StringBuilder template = new StringBuilder().append(EditAddress).append(".").append(store.getStoreTemplate());
        return template.toString();
    }


    @PreAuthorize("hasRole('AUTH_CUSTOMER')")
    @RequestMapping(value = "/updateAddress.html", method = {GET, POST})
