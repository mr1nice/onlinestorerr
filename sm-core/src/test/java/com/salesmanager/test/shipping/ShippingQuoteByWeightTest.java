...
import static com.salesmanager.core.model.system.Environment.TEST;
    ...
    public void testGetCustomShippingQuotesByWeight() throws ServiceException {
        ...
        for (ProductAvailability as : avails) {
            ...
            for (ProductPrice ps : availabilityPrices) {
                out.println(ps.getProductPriceAmount().toString());
            }
        }
        ...
        shippingConfiguration.setShippingBasisType(SHIPPING);
        shippingConfiguration.setShippingType(INTERNATIONAL);
        shippingConfiguration.setShippingPackageType(ITEM);
        ...
        configuration.setEnvironment(TEST.name());
