...
import static com.salesmanager.core.model.catalog.product.attribute.ProductOptionType.Radio;
...
public class ProductTest extends com.salesmanager.test.common.AbstractSalesManagerCoreTestCase {
    ...
    public void testCreateProduct() throws Exception {
        ...
        out.println("Total number of items " + products.size());
        ...
        if (categories != null && categories.size() > 0) {
            for (Category c : categories) {
                out.println("Contains category " + c.getCode());
                ids.add(c.getId());
            }
        }
        ...
        for (Object[] ob : objs) {
            ...
            out.println("Category " + c.getCode() + " has " + ob[1] + " items");
        ...
        out.println("Number of manufacturer for all category " + manufacturers.size());
	...
	private void testViewAttribute(Product product) throws Exception {
        ...
        for (ProductAttribute attribute : attributes) {
            ...
            out.println("Option id " + option.getId() + " OptionValue id " + optionValue.getId());
	...
	private void testInsertAttribute(Product product) throws Exception {
        ...
        attribute.setProductAttributePrice(new BigDecimal(0));
        attribute.setProductAttributeWeight(new BigDecimal(1));
        ...
        attribute.setProductOption(option);
        attribute.setProductAttributePrice(new BigDecimal(0));
        attribute.setProductAttributeWeight(new BigDecimal(0));
        attribute.setProductOption(option);
    ...
    private void testInsertImage(Product product) throws Exception {
        ...
        cmsContentImage.setFileContentType(PRODUCT);
	...
	private void testViewImage(Product product) throws Exception {
        ...
        OutputContentFile contentFile = productImageService.getProductImage(product.getMerchantStore().getCode(), product.getSku(), productImage.getProductImage(), SMALL);
        ...
        contentFile = productImageService.getProductImage(product.getMerchantStore().getCode(), product.getSku(), productImage.getProductImage(), LARGE);
