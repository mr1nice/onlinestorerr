...
import static com.salesmanager.core.model.payments.CreditCardType.VISA;
...
public class OrderTest extends com.salesmanager.test.common.AbstractSalesManagerCoreTestCase {
	...
	public void getMerchantOrders() throws ServiceException {
        ...
        assertNotNull(ordserList);
        assertTrue("Merchant Orders are null.", ordserList.getOrders() != null);
        assertTrue("Merchant Orders count is not one.", (ordserList.getOrders() != null && ordserList.getOrders().size() == 1));
    }
