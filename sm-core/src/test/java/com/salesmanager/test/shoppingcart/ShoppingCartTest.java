...
@Ignore
public class ShoppingCartTest extends AbstractSalesManagerCoreTestCase {
    ...
    public void createShoppingCart() throws Exception {
        ...
        out.println("Before create cart");
        ...
        out.println("Before getting product");
        ...
        out.println("Before getting cart");
