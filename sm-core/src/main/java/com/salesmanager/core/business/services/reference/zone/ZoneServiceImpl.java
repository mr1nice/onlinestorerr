...
import static com.salesmanager.core.business.constants.Constants.UNDERSCORE;
...
public class ZoneServiceImpl extends SalesManagerEntityServiceImpl<Long, Zone> implements
	...
	public List<Zone> getZones(Country country, Language language) throws ServiceException {
		notNull(language, "Language cannot be null");

		List<Zone> zones = null;
		try {

			String countryCode = DEFAULT_COUNTRY;
			if (country != null) {
				countryCode = country.getIsoCode();
			}

			String cacheKey = ZONE_CACHE_PREFIX + countryCode + UNDERSCORE + language.getCode();
