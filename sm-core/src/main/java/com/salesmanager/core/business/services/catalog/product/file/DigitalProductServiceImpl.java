...
public class DigitalProductServiceImpl extends SalesManagerEntityServiceImpl<Long, DigitalProduct> 
	...
	public void delete(DigitalProduct digitalProduct) throws ServiceException {
        ...
        notNull(digitalProduct, "DigitalProduct cannot be null");
        notNull(digitalProduct.getProduct(), "DigitalProduct.product cannot be null");
        digitalProduct = this.getById(digitalProduct.getId());
        super.delete(digitalProduct);
        productDownloadsFileManager.removeFile(digitalProduct.getProduct().getMerchantStore().getCode(), PRODUCT, digitalProduct.getProductFileName());
