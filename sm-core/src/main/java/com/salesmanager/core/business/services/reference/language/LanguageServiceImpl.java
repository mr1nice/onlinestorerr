...
import static com.salesmanager.core.business.constants.Constants.DEFAULT_LANGUAGE;
...
public class LanguageServiceImpl extends SalesManagerEntityServiceImpl<Integer, Language>
    ...
    private static final Logger LOGGER = getLogger(LanguageServiceImpl.class);
