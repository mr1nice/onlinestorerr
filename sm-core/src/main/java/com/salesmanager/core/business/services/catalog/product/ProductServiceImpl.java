...
public class ProductServiceImpl extends SalesManagerEntityServiceImpl<Long, Product> implements ProductService {
	...
	public void delete(Product product) throws ServiceException {
        ...
        notNull(product.getMerchantStore(), "MerchantStore cannot be null in product");
	...
	private void saveOrUpdate(Product product) throws ServiceException {
        ...
        notNull(product, "product cannot be null");
        notNull(product.getAvailabilities(), "product must have at least one availability");
        notEmpty(product.getAvailabilities(), "product must have at least one availability");
