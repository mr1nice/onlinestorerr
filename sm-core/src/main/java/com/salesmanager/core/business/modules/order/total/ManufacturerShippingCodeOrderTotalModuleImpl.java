...
import static com.salesmanager.core.business.constants.Constants.OT_DISCOUNT_TITLE;
import static com.salesmanager.core.business.constants.Constants.OT_SUBTOTAL_MODULE_CODE;
import static com.salesmanager.core.model.order.OrderTotalType.SUBTOTAL;
...
public class ManufacturerShippingCodeOrderTotalModuleImpl implements OrderTotalPostProcessorModule {
    ...
    private static final Logger LOGGER = getLogger(ManufacturerShippingCodeOrderTotalModuleImpl.class);
    ...
    public OrderTotal caculateProductPiceVariation(final OrderSummary summary, ShoppingCartItem shoppingCartItem, Product product, Customer customer, MerchantStore store)
        ...
        notNull(product.getManufacturer(), "product manufacturer must not be null");
        ...
        if (inputParameters.getDiscount() != null) {
            ...
            orderTotal.setOrderTotalCode(OT_DISCOUNT_TITLE);
            orderTotal.setOrderTotalType(SUBTOTAL);
            orderTotal.setTitle(OT_SUBTOTAL_MODULE_CODE);
