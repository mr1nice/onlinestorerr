...
public class ProductReviewServiceImpl extends
	...
	private void saveOrUpdate(ProductReview review) throws ServiceException {
        ...
        notNull(review, "ProductReview cannot be null");
        notNull(review.getProduct(), "ProductReview.product cannot be null");
        notNull(review.getCustomer(), "ProductReview.customer cannot be null");
