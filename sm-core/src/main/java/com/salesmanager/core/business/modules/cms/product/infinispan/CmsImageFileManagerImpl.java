...
import static org.infinispan.tree.Fqn.fromString;
...
public class CmsImageFileManagerImpl
    ...
    public void addProductImage(ProductImage productImage,
        ...
        try {
            ...
            nodePath.append(productImage.getProduct().getMerchantStore().getCode()).append(SLASH).append(productImage.getProduct().getSku()).append(SLASH);
    ...
    public void removeProductImage(ProductImage productImage)
        ...
        try {
            ...
            StringBuilder nodePath = new StringBuilder();
            nodePath.append(productImage.getProduct().getMerchantStore().getCode()).append(SLASH).append(productImage.getProduct().getSku());
    ...
    private OutputContentFile getProductImage(String merchantStoreCode,
        ...
        try {
            ...
            //SMALL by default
            StringBuilder nodePath = new StringBuilder();
            nodePath.append(merchantStoreCode).append(SLASH).append(productCode).append(SLASH).append(size);
    ...
    private Node<String, Object> getNode(final String node) {
        ...
        Fqn contentFilesFqn = fromString(merchantPath.toString());
